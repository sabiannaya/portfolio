...
<template>
    <div class="flex flex-col items-center justify-center">
        <div class="flex flex-col sm:flex-row items-center">
            <span class="sm:w-[55vw] h-full justify-center flex flex-col gap-5">
                <span
                    class="text-4xl text-teal-50 font-bold bg-teal-500 w-fit translate-x-5 translate-y-14 px-5 py-2 rounded-sm">
                    About Me
                </span>
                <span class="border border-teal-100 w-[90vw] sm:w-[50vw] px-5 pt-16 pb-8">
                    ...
                    <div class="flex flex-row md:grid md:grid-cols-3 justify-around pt-3">
                        <div>
                            <ol class="px-5 md:px-10 list-disc text-slate-400 md:text-lg">
                                <li>Vue 3</li>
                                <li>Laravel (v10)</li>
                                <li>Tailwind</li>
                            </ol>
            ...
            <img :src="bandungImg" class="object-cover w-56 md:w-60 lg:w-68 h-60 md:h-64 lg:h-72 translate-y-10" />
        </div>
    </div>
</template>
